...
> rowMeans(mydata[,c("ofohr8.3","auflt8.9","mitw8.10","eamt8.11","hosp8.12","pdar8.13",
"eins8.14","besw8.15","ents8.16","eazf8.17","ifpd8.18","betl8.19")],na.rm=TRUE)


# Korellation zwischen Gesamteinschätzung und den beiden Faktoren:
